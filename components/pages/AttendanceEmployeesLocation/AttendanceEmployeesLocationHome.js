...
const AttendanceEmployeesLocationHome = () => {
  const [locations, setLocations] = useState([]);
  const [employees, setEmployees] = useState([]);
  const [latitude, setLatitude] = useState(null);
  const [longitude, setLongitude] = useState(null);
  const [defaultLocID, setDefaultLocID] = useState(null);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "https://eg32mvlk9thcnja-dev.adb.uk-london-1.oraclecloudapps.com/ords/hits_dev/ssmb/get_employees_with_locations",
        {
          params: {
            p_person_id: null,
            p_requester_id: null,
            ...
            <>
              ...
              <SelectDropdown
                ...
                onSelect={(selectedItem, index) => {
                  ...
                  setValue("location_id", selectedItem.location_id);
...
export default AttendanceEmployeesLocationHome;
